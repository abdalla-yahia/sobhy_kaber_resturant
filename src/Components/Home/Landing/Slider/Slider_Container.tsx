                ...
                slider?.map(e=>
                    <div key={e.id} className="w-full relative min-h-screen flex-shrink-0">
                        ...
                        <div  className={`w-full flex-shrink-0 min-h-screen bg-center bg-cover flex flex-col justify-center ${e.id === 1 ? 'items-center': 'items-end'} px-20 gap-5`} style={{backgroundImage:`url(${e.image})`}}>
                            <h2 className={` ${e.id === 2 ?'text-primary':'text-white'} z-50 text-[30px] md:text-[40px] font-extrabold w-full md:w-[50%] ${e.id === 1 ? 'text-center':'text-end'}`}>
                                {e.title}
                            </h2>
                            <p className="text-[10px] md:text-[20px] w-full md:w-[50%] z-50 text-white text-center" style={{letterSpacing:'10px'}}>
                                {e.paragraph}
                            </p>
